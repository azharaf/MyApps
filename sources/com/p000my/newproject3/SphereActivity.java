...
/* renamed from: com.my.newproject3.SphereActivity */
public class SphereActivity extends Activity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(C0011R.layout.sphere);
        initialize(bundle);
        initializeLogic();
    }
    ...
    private void initialize(Bundle bundle) {
        ...
        this.button1.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                if (SphereActivity.this.edittext1.getText().toString().equals("")) {
                    SketchwareUtil.showMessage(SphereActivity.this.getApplicationContext(), "Please enter correct value");
                    return;
                }
                SphereActivity.this.f13r = Double.parseDouble(SphereActivity.this.edittext1.getText().toString());
                SphereActivity.this.textview3.setText(String.valueOf(12.566370614359172d * SphereActivity.this.f13r * SphereActivity.this.f13r));
                SphereActivity.this.textview5.setText(String.valueOf(3.141592653589793d * SphereActivity.this.f13r * SphereActivity.this.f13r * SphereActivity.this.f13r));
            }
        });
    }
